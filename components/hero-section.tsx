...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 max-w-7xl mx-auto text-center">
        <motion.div
        ...
        >
          ...
          <span className="text-sm text-foreground/80">Tokeniza, Automatiza y Verifica</span>
        </motion.div>
        ...
        >
          Digitaliza, automatiza y tokeniza con Trazzos para construir confianza, eficiencia y valor económico desde el
          origen.
        </motion.p>
