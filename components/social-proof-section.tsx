...
export function SocialProofSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-foreground/60 text-balance">
            Productores en Colombia, Shanghái y Nueva York
          </p>
        </motion.div>
        ...
        >
          <Card className="relative p-12 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-md border-primary/20 overflow-hidden">
            ...
            <div className="relative">
              ...
              >
                "Nuestros clientes ahora conocen el origen exacto de cada
                botella. La confianza ha aumentado, y nuestras ventas también."
              </motion.blockquote>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(rgba(154, 255, 141, 0.5) 1.5px, transparent 1.5px)",
