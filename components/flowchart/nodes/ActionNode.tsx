...
export const ActionNode = memo(function ActionNode({
  ...
  return (
    <div
      className={cn(
        "group relative flex min-w-[230px] max-w-[320px] flex-col gap-4 rounded-3xl border border-white/10 bg-gradient-to-br from-card/80 to-card/40 px-7 py-6 text-left text-foreground shadow-lg backdrop-blur transition-all duration-300 ease-out opacity-0",
